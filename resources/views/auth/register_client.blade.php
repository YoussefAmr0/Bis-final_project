...
<div class="signup">
    ...
    <div class="content">
        <form method="POST" action="{{route('sample.validate_registration_client')}}">
            @csrf
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <input id="email" type="text" class="form-control @error('name') is-invalid @enderror" name="type"  value="client" hidden required >
